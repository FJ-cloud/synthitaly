...
|---|---|---|
| **Consumer** | `n_consumers` (≈150) | A household. Receives income, pays bills/debt, buys from merchants, sweeps any monthly surplus to savings/pension. The only *active decision-maker*. |
...
### Calendar multipliers — *Emiliozzi et al. (2023) §3 / §11*
